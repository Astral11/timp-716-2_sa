...
int isEmpty()//поверка на пустоту 
{ 
...
void init (int value)//инициализация
{
...
void add_end(int num, int data)//добавления в конец
{
...
void add_pend(int num, int data)//добавление в начало
{ 
	node *tmp = find_node_num(num);
